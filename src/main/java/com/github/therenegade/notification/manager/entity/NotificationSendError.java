...
@Entity
@Table(name = "sending_error", schema = "notifications")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
...
public class NotificationSendError {
    ...
    @ManyToOne
    @JoinColumn(name = "sending_queue_id")
    private NotificationSendQueue notificationSendQueue;
    ...
    public boolean equals(Object o) {
        ...
        NotificationSendError that = (NotificationSendError) o;
